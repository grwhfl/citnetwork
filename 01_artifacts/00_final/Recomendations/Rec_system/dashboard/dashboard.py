...
# articles_idx = df['id'].tolist()
# art = x = ", ".join(articles_idx)
# df_article_author = pd.read_sql(f"select * from dblps.tarticle2tauthor where article_idx in ({art})", con=con)[col]
...
app.layout = html.Div([
    ...
    html.Div(style={'text-align': 'center'}, 
        ...
        html.Iframe(srcDoc=nt.html,
                    style={"height": "600px", "width": "50%", 'align': 'center'})
    ])
